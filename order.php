...
<?php
    ...
    if(isset($_GET['food_id'])){
        //get food id & details of selected food
        ...
        <div class="container">
            ...
            <?php
                ...
                if(isset($_POST['submit'])){
                    ...
                    $costomer_name= $_POST['full-name'];
                    $costomer_contact= $_POST['contact'];
                    $costomer_email= $_POST['email'];
                    $costomer_address= $_POST['address'];
                    ...
                    if($res2==true){
                        ...
                        //falled to save order
                        $_SESSION['order'] = "<div class='error text-center'>Faled to Order Food.</div>";
                        header('location:'.$SITEURL);
                    }
                }
            ?>
